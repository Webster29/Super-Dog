...
while keepGoing.lower() == "yes":
    ...
    while (len(dog) == 0):
        dog =input("Please enter your Super Dog's name:  ")

    owner =input("\nWhat famous Hero adopted our Super Dog?  ")
    while (len(owner) == 0):
        owner =input("Please enter a famous Hero that adopted our Super Dog:  ")

    city =input("\nWhat city does our Super Dog Protect?  ")
    while (len(city) == 0):
        city =input("Please enter the city that Super Dog protects:  ")
